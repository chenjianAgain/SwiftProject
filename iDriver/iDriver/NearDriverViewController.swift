...
class NearDriverViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate,UITableViewDataSource, UITableViewDelegate {
    ...
    func driverList(){
        ...
        self.driverListTableView!.registerClass(UITableViewCell.self, forCellReuseIdentifier: "nearDriverCell")
    ...
    func tableView(tableView: UITableView!, cellForRowAtIndexPath indexPath: NSIndexPath!) -> UITableViewCell!{
        let cell = tableView.dequeueReusableCellWithIdentifier("nearDriverCell", forIndexPath: indexPath) as UITableViewCell!
