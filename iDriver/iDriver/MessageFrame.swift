...
let kIconWH : CGFloat = 90  //头像宽高
let kContentW : CGFloat = 180  //内容宽度
let kContentTop : CGFloat = 30  //文本内容与按钮上边缘间隔
let kContentLeft : CGFloat = 25  //文本内容与按钮左边缘间隔
let kContentBottom : CGFloat = 30  //文本内容与按钮下边缘间隔
...
class MessageFrame: NSObject {
    ...
    func setMessage(message : Message){
        ...
        // 2.1 如果是自己发得，头像在右边
        if type == MessageType.MessageTypeMe{
