...
////        registerNav!.view.addSubview(imageView)
        self.tabBarVC!.view.addSubview(imageView)
//        /*欢迎界面几秒后移除*/
       let timmer:NSTimer =  NSTimer.scheduledTimerWithTimeInterval(SPLASH_SCREEN_WAIT_TIME, target:self, selector:"removePIC", userInfo:nil, repeats:false)
